...
//Source: 3rd Party source lost (October 2021)

/// <summary>
/// Adds extra methods to Quaternion using Extensions feature in C#
/// Note - We CANNOT use a namespace when we add extension methods. If we do, then the extensions will not appear in the target class e.g. Quaternion
/// </summary>
